      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto" style={{ transform: `translateY(${scrollY * 0.5}px)` }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a href="https://expo.dev/artifacts/eas/cNernjK9wDPsANAucsqnFD.apk" className="group relative px-8 py-4 bg-gradient-to-r from-red-600 to-red-800 rounded-full font-bold text-lg hover:scale-105 transition-transform flex items-center space-x-2 shadow-2xl shadow-red-900/50">
