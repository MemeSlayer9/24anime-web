...
function AnimeKaiPlayer() {
  ...
  const videoUrl = m3u8Url ? `https://rust-proxy-m3u8.onrender.com/?url=${encodeURIComponent(m3u8Url)}` : '';
  ...
  const filteredEpisodes = episodes.filter(episode => {
    ...
    if (episodeRange !== "all") {
      ...
      matchesRange = episodeNum >= start && episodeNum <= end;
    }
              ...
              {(() => {
                ...
                return previousEpisode ? (
                  <button
                    ...
                    className="flex items-center justify-center bg-black hover:bg-red-900/30 p-3 sm:p-4 rounded-xl transition-all transform hover:scale-105 border border-red-900/50 min-w-[100px]"
                  >
                    <BackIcon />
                    <div className="text-center ml-2">
                      <div className="text-xs text-gray-400">Previous</div>
                      <div className="font-bold">EP {previousEpisode.episode}</div>
                    </div>
                  </button>
                ) : (
                  <div className="flex items-center justify-center bg-gray-800/50 p-3 sm:p-4 rounded-xl min-w-[100px] text-gray-500 text-sm">
                    No Previous
                  </div>
                );
              })()}

              <div className="flex-1 bg-gradient-to-br from-red-950/50 to-black/50 p-3 sm:p-4 rounded-xl border border-red-900/50">
                <button
                  onClick={() => {
                ...
                > 
                  <h1 className="text-lg sm:text-xl font-bold mb-2 capitalize">
                    {animeTitle}
                  </h1>
                </button>
              ...
              {(() => {
                ...
                return nextEpisode ? (
                  <button
                    ...
                    className="flex items-center justify-center bg-gradient-to-br from-red-600 to-red-900 hover:from-red-500 hover:to-red-800 p-3 sm:p-4 rounded-xl transition-all transform hover:scale-105 shadow-lg min-w-[100px]"
                  >
                    <div className="text-center mr-2">
                      <div className="text-xs text-red-200">Next</div>
                      <div className="font-bold">EP {nextEpisode.episode}</div>
                    </div>
                ...
                {filteredEpisodes.map((episode) => (
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <div className="text-xs sm:text-sm font-bold">Episode {episode.episode}</div>
