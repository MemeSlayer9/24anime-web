...
export default function AnimePopularSlider() {
  ...
  useEffect(() => {
    axios
      .get('maaa/api/popular?perPage=10')
      .then((response) => {
        ...
        {animes.map((anime, index) => (
          ...
          >
            ...
            <div className="flex-shrink-0 w-20 h-30 rounded-md overflow-hidden">
              <img
                src={anime.coverImage?.extraLarge || anime.coverImage?.large || 'https://via.placeholder.com/80x112/1a1a1a/666666?text=N/A'}
            ...
            <div className="flex-1 min-w-0">
              ...
              {anime.averageScore && (
                <div className="flex items-center gap-1 mt-2">
                  ...
                  <span className="text-gray-400 text-xs">{anime.averageScore}/100</span>
                </div>
              )}
            </div>
          </div>
